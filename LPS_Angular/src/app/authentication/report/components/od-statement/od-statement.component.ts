...
@Component({
  selector: 'app-od-statement',
  templateUrl: './od-statement.component.html',
  styleUrls: ['./od-statement.component.scss']
})
export class OdStatementComponent implements OnInit, OnDestroy {
