...
export class AccountServiceComponent implements OnInit {
  ...
  constructor(private accService: AccountService, private errorService: ErrorService, private decimalPipe: DecimalPipe) { }
  ngOnInit() {

    // $('#accordion-loan').ready(() => {
    //   $('html, body').delay(5000).animate({
    //     scrollTop: $('#accordion-loan').offset().top + 200
    //   }, 1000);
    // });
  }
